...
from mmtrack.core import SeqEpochBasedRunner
...
def train_model(model,
    ...
    if cfg.get('seq_runner', False):
        Runner = SeqEpochBasedRunner
        meta['num_frames'] = cfg.num_frames
    runner = Runner(
        model,
        optimizer=optimizer,
    ...
    if validate:
        ...
        eval_cfg['greater_keys'] = ['MOTA', 'HOTA']
